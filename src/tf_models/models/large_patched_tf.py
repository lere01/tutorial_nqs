...
from tf_models.models.patched_tf import *
...
class LPTF(Sampler):
    ...
    @torch.jit.export
    def logprobability(self, input: Tensor) -> Tensor:
    ...
    @torch.jit.export
    def sample(self, B:int, L: int, cache: Optional[Tensor] = None) -> Tuple[Tensor, Tensor]:
