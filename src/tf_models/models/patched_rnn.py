"""With permission from the author, this code was taken from the following repository:
    https://github.com/APRIQuOt/VMC_with_LPTFs
"""

import torch
from torch import nn, Tensor
from typing import Tuple, Optional
from tf_models.utilities import Options,OptionManager
from .base import Sampler, Patch1D, Patch2D, genpatch2onehot, device
...
class PRNN(Sampler):
    ...
    @torch.jit.export
    def logprobability(self, input: Tensor, h0: Optional[Tensor]=None) -> Tensor:
    ...
    @torch.jit.export
    def sample(self, B: int, L: int, h0: Optional[Tensor]=None) -> Tuple[Tensor,Tensor]:
    ...
    @torch.jit.export
    def off_diag_labels(self, sample: Tensor, nloops: int = 1) -> Tensor:
